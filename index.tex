...
\FunctionTok{head}\NormalTok{(data[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{5}\NormalTok{,}\DecValTok{2}\SpecialCharTok{:}\DecValTok{6}\NormalTok{]) }\SpecialCharTok{|\textgreater{}} \CommentTok{\# eerste 5 rijen en kolommen}
\FunctionTok{gt}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{tab\_header}\NormalTok{(}\AttributeTok{title =} \StringTok{"Voorbeeld van de data"}\NormalTok{) }\SpecialCharTok{|\textgreater{}} \CommentTok{\# titel geven aan output}
  \FunctionTok{opt\_stylize}\NormalTok{(}\AttributeTok{style =} \DecValTok{6}\NormalTok{, }\AttributeTok{color =} \StringTok{"blue"}\NormalTok{) }\CommentTok{\# lay{-}out bepalen}
\end{Highlighting}
\end{Shaded}

\begin{table}
\caption*{
{\fontsize{20}{25}\selectfont  Voorbeeld van de data\fontsize{12}{15}\selectfont }
} 
\fontsize{12.0pt}{14.0pt}\selectfont
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}crcrr}
\toprule
geslacht & leeftijd & opleidingsniveau & alcohol\_ooit & alcohol\_laatste\_jaar \\ 
...
sociale wetenschappen zijn er verschillende type variabelen, die ook wel
\textbf{meetniveaus} worden genoemd. Deze bespreken we hier en daarbij
gaan we meteen in op hoe we de data van deze variabelen het beste
...
Het gemiddelde van een variabele is simpelweg het optellen van alle
waarden, gedeeld door het aantal observaties. Dit gaat middels de
volgende formule.
